...
export default function PromoBanner() {
  return (
    <section className="relative w-full flex flex-col md:flex-row items-center justify-between bg-[#18181b] rounded-lg shadow-lg mb-10 overflow-visible">
      <div className="flex-1 p-8 z-10">
        <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2 drop-shadow-lg">
          The Cards Everybody Wants
        </h2>
        <p className="text-lg text-[#01FF04] font-semibold mb-4">
          Encuentra las cartas más buscadas y productos exclusivos de Pokémon TCG.
        </p>
        <a
          href="/productos"
          className="bg-[#01FF04] text-[#111111] px-6 py-2 rounded font-bold shadow hover:bg-[#1BA1F1] hover:text-white transition"
        >
          Ver más
        </a>
      </div>
